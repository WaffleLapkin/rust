...
impl<'cx, 'tcx> crate::MirBorrowckCtxt<'cx, 'tcx> {
    ...
    pub(crate) fn cannot_use_when_mutably_borrowed(
        ...
        err.span_label(borrow_span, format!("borrow of {borrow_desc} occurs here"));
    ...
    pub(crate) fn cannot_reborrow_already_borrowed(
        ...
        if msg_new == "" {
            ...
            err.span_label(old_span, format!("{kind_old} borrow occurs here{}", via(msg_old)));
        }
    ...
    pub(crate) fn cannot_assign_to_borrowed(
        ...
        err.span_label(borrow_span, format!("borrow of {desc} occurs here"));
        err.span_label(span, format!("assignment to borrowed {desc} occurs here"));
        err
    }
